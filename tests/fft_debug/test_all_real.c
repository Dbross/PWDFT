...
int main() {
    ...
    printf("=== Testing Real FFT Routines ===\n");
    
    // Test drffti_ with nx dimension (real FFT)
    failures += test_fft_routine("drffti_nx", drffti_, 2*28+15);
    
    printf("=== Real FFT Test Summary ===\n");
    printf("Failures: %d\n", failures);
